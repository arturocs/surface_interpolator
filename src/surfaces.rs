...
fn uij11(i: f32, j: f32, h: f32) -> (f32, f32) {
    ...
    ((3.0 * vij1.0 + vij2.0) / 4.0, (3.0 * vij1.1 + vij2.1) / 4.0)
}
...
fn eij10(i: f32, j: f32, h: f32) -> (f32, f32) {
    let vij1 = vij(i, j, h);
    let vij2 = vij(i + 1.0, j, h);
    ((vij1.0 + vij2.0) / 2.0, (vij1.1 + vij2.1) / 2.0)
}
...
fn zij11(i: f32, j: f32, h: f32) -> (f32, f32) {
    ...
    let vij2 = vij(i + 1.0, j, h);
    (
        (2.0 * vij1.0 + vij2.0 + vij2.0) / 4.0,
        (2.0 * vij1.1 + vij2.1 + vij2.1) / 4.0,
    )
}
...
fn tij(i: f32, j: f32, h: f32) -> (f32, f32) {
    ...
    let vij2 = vij(i + 1.0, j, h);
    (
        (vij1.0 + vij2.0 + vij2.0) / 3.0,
        (vij1.1 + vij2.1 + vij2.1) / 3.0,
    )
}
...
fn wij11(i: f32, j: f32, h: f32) -> (f32, f32) {
    let vij1 = vij(i, j, h);
    let vij2 = vij(i + 1.0, j + 1.0, h);
    ((2.0 * vij1.0 + vij2.0) / 3.0, (2.0 * vij1.1 + vij2.1) / 3.0)
}
